...
void initTileFloor(){
	...
	tileShader->setInt(tileShader, "tileTexture", 0);
	...
	float floorVertices[] = {
		0, t_z_max, t,l,	//TopLeft
		0, t_z_max, t,r,//TopRight
		0, t_z_min, b,r,//BottomRight
		0, t_z_max, t,l,//TopLeft
		0, t_z_min, b,l,//BottomLeft
		0, t_z_min, b,r//BottomRight
	};
	// float floorVertices[] = {
	...
	tileTexture = loadTexture("textures/tile.png");
